...
print('NEGA CALCULATOR 2.0')
print('By JOSIAS AUREL')
...
while True:
        ...
        if operation == 'addition': #addition operation
            ...
            print('UNKNOWN COMMAND') #error handling if user input is not included in the program
...
#Thanks for using NEGA CALCULATOR 2.0 by Josias Aurel
